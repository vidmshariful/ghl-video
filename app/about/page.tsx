                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  ...
                  {otherBrands.map((b) => (
                    <a
                      ...
                      target="_blank"
                      rel="noopener"
                      className="tap inline-flex items-center gap-2 rounded-full border border-hair bg-surface px-4 py-2 font-mono text-label uppercase text-muted transition-colors hover:border-gold/50 hover:text-gold"
                    >
                      {b.name}
